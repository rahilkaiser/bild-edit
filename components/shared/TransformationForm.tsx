    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div
                    className="flex lg:flex-row lg:justify-between lg:space-x-16 lg:items-stretch flex-col space-y-8 min-h-[250px] lg:space-y-0">
                    <CustomField
                    ...
                    <div className="flex-grow w-full">
                        <h3 className="pb-4 text-center">Transformed</h3>
                        <TransformedImage
                            image={image}
                            type={type}
                ...
                <div className="flex flex-col gap-4 items-start">
                    <Button
                        type="button"
                        className="uppercase w-full h-[52px]"
                        disabled={isTransforming || newTransformation === null}
                        onClick={onTransformHandler}
                    >
                        {isTransforming ? "Transforming..." : "Apply Transformation"}
                    </Button>
                    <Button type="submit" className="uppercase w-full h-[52px]" disabled={isSubmitting}>
